...
export async function generationAvailability(ctx: QueryCtx, generationProvider: GenerationProvider = "nim", operatorCanary = false) {
  ...
  if (!config.FIRECRAWL_API_KEY) return { enabled: false, message: "Research is awaiting service setup. Please try again later." };
